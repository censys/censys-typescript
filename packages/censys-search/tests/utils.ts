...
export const BASE_URL = "https://search.censys.io/api";
export const BASE_URL_V1 = `${BASE_URL}/v1`;
export const BASE_URL_V2 = `${BASE_URL}/v2`;
export const API_ID = "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx";
export const API_SECRET = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx";
export const CLIENT_CONFIG = { API_ID, API_SECRET };
export const BASIC_AUTH = Buffer.from(`${API_ID}:${API_SECRET}`).toString(
    "base64"
);
